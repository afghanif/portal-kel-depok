...
const InformasiSetiapSaat = ( {dataSetiapSaat, profilSite, visit}: any ) => {
  return (
    <div>
      ...
      <main className="pt-[5.5rem] lg:pt-24">
        ...
        <section className="py-24 dark:bg-jacarta-900">
          <div className="container">
            ...
            {dataSetiapSaat && dataSetiapSaat.filter((sort: any) => sort.ParentId === null).reverse().map((item: any, index : number) => {
              ...
              return (
                <div role="table"
                  ...
                  {dataSetiapSaat && dataSetiapSaat.filter((sort: any) => sort.ParentId === item.content_id).reverse().map((parent : any, count : number) => {
                      return(
                        <>
                          ...
                          {dataSetiapSaat && dataSetiapSaat.filter((indx: any) => indx.ParentId === parent.content_id).map((child : any, bet : number) => {
